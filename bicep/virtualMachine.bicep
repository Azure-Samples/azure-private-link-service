...
// Resources
resource loadBalancer 'Microsoft.Network/loadBalancers@2021-08-01' existing = if (!empty(loadBalancerName)) {
...
resource customScriptExtension 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = if (!empty(scriptFilePath) && !empty(scriptFileName)) {
